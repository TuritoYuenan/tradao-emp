...
// This Discord bot uses meeting information to create an ICS file
// Members can use this ICS file to add to Google Calendar
...
async function home(request: Request) {
	// validateRequest() ensures that a request is of POST method and has the following headers.
