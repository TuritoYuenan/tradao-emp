export default function Banner({ title, description }: { title: string; description?: string }) {
	return (
		<header
			className='m-4 mb-8 p-12 text-center rounded-2xl shadow-xl relative'
			style={{
				color: 'var(--dark-green)',
				backgroundColor: 'var(--green)',
				borderRadius: '1rem 8rem',
			}}
		>
			<div
				id='leaf'
				className='absolute aspect-square z-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'
				style={{
